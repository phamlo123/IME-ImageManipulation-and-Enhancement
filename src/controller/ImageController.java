...
/**
 * Represents a controller for image processing, allowing the user to input certain commands
 * and the controller has the model execute those commands.
 */
public interface ImageController {
   ...
   * @throws IllegalStateException if there is nothing left from the user to read
   */
  void processFile(File fileName) throws FileNotFoundException, IllegalStateException;
