...
/**
 * Class to hold all of the SimpleImageController examples used for testing.
 */
public class ControllerExamples {
  ...
  String toString4 = "Please enter a valid command\n"
      + "Program ended";

  String toString5 = "Please enter a valid number\n"
      + "Program ended";

  String toString6 = "Please enter a valid file format\n"
      + "Program ended";
  ...
  String toString7 = "Available commands include:\n"
      ...
      + "end //ends the program\n"
      + "\n"
      + "Index 5 out of bounds, Please enter a valid command\n"
      + "Program ended";

  String toString8 = "Index 5 out of bounds, Please enter a valid command\n"
      + "Program ended";
