...
public class ImagesImplTest {
  ...
  public void testCreateMonochromeCheckerboard() {
    ...
    Images images = new ImagesImpl(examples.ppmExample4);
  ...
  public void testCreateMonochromeImported() {
    ...
    Images images = new ImagesImpl(new Image("sample.ppm"));
    images.createMonochrome();
  ...
  public void testCreateSepiaImported() {
    ...
    Images images = new ImagesImpl(new Image("Northeastern.ppm"));
    images.createSepia();
